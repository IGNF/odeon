...
class ErrorCodes(Enum):
    ...
    """ happens when a critical tests of interection returns false"""
...
class ODNError(Exception):
    """
    Custom Exception for Odeon project
    """

    def __init__(self, error_code: Union[int, ErrorCodes], message: str = '', stack_trace: Any = None, *args, **kwargs):
        """
        ...
        if not isinstance(error_code, ErrorCodes):
            ...
            raise ODNError(ErrorCodes.ERR_INCORRECT_ERRCODE, msg, args=[ErrorCodes.__class__.__name__])
