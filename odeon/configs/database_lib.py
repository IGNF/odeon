...
def register_configs() -> None:
    ...
    config_store.store(name='config_schema', node=OdeonConfig)

    # Store core classes structured schema
    config_store.store(name='files', node=Files)
    config_store.store(name='datamodule', node=DataModuleConf)
    config_store.store(name='transforms', node=TransformsConf)
    ...
    config_store.store(group='callbacks', name='learning_rate_monitor', node=LearningRateMonitorConf)
    config_store.store(group='callbacks', name='model_checkpoint_schema', node=ModelCheckpointConf)
    ...
    config_store.store(group='callbacks', name='custom_pred_writer', node=CustomPredictionWriterConf)
    ...
    # Store models
    config_store.store(group='models', name='unet', node=UnetOdeonConf)
    config_store.store(group='models', name='lightunet', node=LightUnetOdeonConf)
    config_store.store(group='models', name='deeplab', node=DeepLabOdeonConf)
    config_store.store(group='models', name='unet_smp', node=UnetSmpConf)
    config_store.store(group='models', name='deeplabv3_smp', node=DeepLabV3SmpConf)
    config_store.store(group='models', name='deeplavv3plus_smp', node=DeepLabV3PlusSmpConf)
    config_store.store(group='models', name='fpn_smp', node=FPNSmpConf)
    config_store.store(group='models', name='linknet_smp', node=LinknetSmpConf)
    config_store.store(group='models', name='manet_smp', node=MAnetSmpConf)
    config_store.store(group='models', name='pan_smp', node=PANSmpConf)
    config_store.store(group='models', name='pspnet_smp', node=PSPNetSmpConf)
