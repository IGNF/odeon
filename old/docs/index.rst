...
First, download and extract a copy of odeon from `repository <https://github.com/IGNF/odeon>`_
...
.. code-block:: console
   ...
   $ clone repository https://github.com/IGNF/odeon.git
   $ cd odeon
